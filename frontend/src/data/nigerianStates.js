export const nigerianStates = {
    "Abia": [
        "Aba", "Arochukwu", "Bende", "Ikwuano", "Isiala Ngwa North", "Isiala Ngwa South", 
        "Isuikwuato", "Obi Ngwa", "Ohafia", "Osisioma Ngwa", "Ugwunagbo", "Ukwa East", 
    ...
    "Federal Capital Territory": [
        "Abuja Municipal Area Council", "Gwagwalada", "Kuje", "Kwali", "Abaji"
    ],
    "Gombe": [
...
export const getCitiesForState = (state) => {
    return nigerianStates[state] || [];
};

export const getAllStates = () => {
    return Object.keys(nigerianStates);
}; 