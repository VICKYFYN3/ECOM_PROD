    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 py-8'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <form onSubmit={onSubmitHandler} className='flex flex-col lg:flex-row gap-8'>
          ...
          <div className='flex-1 bg-white rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100'>
            <div className='mb-8'>
              ...
              <div className="flex bg-gray-100 rounded-xl p-1 mb-6">
                <button
                  ...
                  className={`flex-1 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 ${addressTab === 'saved'
                ...
                <button
                  ...
                  className={`flex-1 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 ${addressTab === 'new'
                      ? 'bg-white text-blue-600 shadow-sm'
                      : 'text-gray-600 hover:text-gray-900'
                    }`}
                >
              ...
              <div className="space-y-4">
                {loading ? (
                  ...
                  <div className="text-center py-12 bg-gray-50 rounded-xl">
                    ...
                    <p className="text-gray-500 text-lg">No saved addresses found</p>
                    <p className="text-gray-400 text-sm mt-1">Please add a new address to continue</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {addresses.filter(addr => addr.addressType === 'shipping').map(address => (
                      <div
                        key={address._id}
                        className={`group relative p-6 border-2 rounded-xl cursor-pointer transition-all duration-200 ${selectedAddress === address._id
                      ...
                      >
                        <div className="flex items-start space-x-4">
                          <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center mt-1 ${selectedAddress === address._id ? 'border-blue-500 bg-blue-500' : 'border-gray-300'
                            }`}>
          ...
          <div className='w-full lg:w-96 bg-white rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100 h-fit'>
            <div className='flex items-center space-x-3 mb-6'>
            ...
            <div className='mt-8'>
              ...
              <div className='space-y-3'>
                <div
                  ...
                  className={`flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 ${method === 'stripe' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'
                    }`}
                >
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${method === 'stripe' ? 'border-blue-500 bg-blue-500' : 'border-gray-300'
                    }`}>
                    {method === 'stripe' && <div className="w-2 h-2 bg-white rounded-full"></div>}
                  </div>
                  <img className='h-6 ml-4' src={assets.stripe_logo} alt="Stripe" />
                </div>

                <div
                  onClick={() => setMethod('paystack')}
                  className={`flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 ${method === 'paystack' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'
                    }`}
                >
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${method === 'paystack' ? 'border-blue-500 bg-blue-500' : 'border-gray-300'
                    }`}>
                    {method === 'paystack' && <div className="w-2 h-2 bg-white rounded-full"></div>}
                  </div>
                  <img className='h-6 ml-4' src={assets.paystack_logo} alt="Paystack" />
                </div>

                <div
                  onClick={() => setMethod('cod')}
                  className={`flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 ${method === 'cod' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'
                    }`}
                >
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${method === 'cod' ? 'border-blue-500 bg-blue-500' : 'border-gray-300'
                    }`}>
                  ...
                  <div className='ml-4 flex items-center'>
                    ...
                    <span className='text-l font-bold text-gray-700'>Cash on Delivery</span>
                  </div>
                </div>
              </div>
            </div>
